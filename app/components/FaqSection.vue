    ...
    <div class="mx-auto max-w-4xl px-6 lg:px-8">
      ...
      <div class="mt-12 space-y-4">
        ...
        >
          ...
          <!-- Remplacement de l'animation personnalisée par une transition standard de Tailwind -->
          <div
            v-show="faq.isOpen"
            class="overflow-hidden transition-all duration-300"
          >
            <!-- CORRECTION : Suppression du pt-1 en doublon, conservation du pt-4 uniquement -->
            <div class="px-6 pb-6 text-sm sm:text-base leading-7 text-gray-600 border-t border-gray-100 mt-1 pt-4">
              {{ faq.answer }}
            </div>
          </div>
        </div>
